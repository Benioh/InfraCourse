"""L15 Patch · 1F1B Pipeline Schedule generator."""
...
def make_1f1b_schedule(num_stages: int, num_microbatches: int) -> list[list[tuple[str, int]]]:
    ...
    raise NotImplementedError("L15: implement make_1f1b_schedule")
...
def bubble_count(num_stages: int) -> int:
    ...
    raise NotImplementedError("L15: implement bubble_count")
