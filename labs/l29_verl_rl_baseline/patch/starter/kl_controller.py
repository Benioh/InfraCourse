"""
L31 Patch · Adaptive KL Controller (Ouyang 2022)
...
class AdaptiveKLController:
    ...
    def __init__(self, init_kl_coef: float, target_kl: float, horizon: int) -> None:
        ...
        raise NotImplementedError("L31: implement __init__")
    ...
    def update(self, current_kl: float, n_steps: int = 1) -> None:
        ...
        raise NotImplementedError("L31: implement update")

    def get_coef(self) -> float:
        # TODO(student): return self.value
        raise NotImplementedError("L31: implement get_coef")
